 ...
 *
 *    $ssh = new \mazter\Net\SSH1('www.domain.tld');
...
class SSH1
{
     ...
     * Encryption Methods
     *
     * @see \mazter\Net\SSH1::getSupportedCiphers()
     * @access public
     */
    /**
     * No encryption
     ...
     *
     * @see \mazter\Net\SSH1::getSupportedAuthentications()
     * @access public
     */
    /**
     ...
     * The Response Type
     *
     * @see \mazter\Net\SSH1::_get_binary_packet()
     * @access private
     */
    ...
    function _connect()
    {
        ...
        switch ($cipher) {
                ...
                //    $this->crypto = new \mazter\Crypt\Null();
                //    break;
     ...
     *
     * To execute further commands, a new \mazter\Net\SSH1 object will need to be created.
     *
    ...
    function exec($cmd, $block = true)
    {
        ...
        // reset the execution bitmap - a new \mazter\Net\SSH1 object needs to be created.
        $this->bitmap = 0;
