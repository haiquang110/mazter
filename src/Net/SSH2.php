 ...
 *
 *    $ssh = new \mazter\Net\SSH2('www.domain.tld');
...
namespace mazter\Net;

use mazter\Crypt\Base;
use mazter\Crypt\Blowfish;
use mazter\Crypt\Hash;
use mazter\Crypt\Random;
use mazter\Crypt\RC4;
use mazter\Crypt\Rijndael;
use mazter\Crypt\RSA;
use mazter\Crypt\TripleDES;
use mazter\Crypt\Twofish;
use mazter\Math\BigInteger; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use mazter\System\SSH\Agent;
...
class SSH2
{
     ...
     *     the other side.
     *
     * @see \mazter\Net\SSH2::_send_channel_packet()
     * @see \mazter\Net\SSH2::_get_channel_packet()
     * @access private
     */
     ...
     *
     * @param string $algorithm Name of the encryption algorithm
     * @return mixed Instance of \mazter\Crypt\Base or null for unknown
     * @access private
     */
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \mazter\Crypt\RSA object or an array
     *
    ...
    function _keyboard_interactive_process()
    {
        ...
        switch ($type) {
            case NET_SSH2_MSG_USERAUTH_INFO_REQUEST:
                ...
                */
                // maybe mazter should force close the connection after x request / responses?  unless something like that is done
     ...
     *
     * @param string $username
     * @param \mazter\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \mazter\Crypt\RSA $privatekey
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
     ...
     * Execute Command
     *
     * If $callback is set to false then \mazter\Net\SSH2::_get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    function exec($command, $callback = null)
    {
        ...
        // honestly, if you're transferring more than 2GB, you probably shouldn't be using mazter, anyway.
        ...
        // down.  the one place where it might be desirable is if you're doing something like \mazter\Net\SSH2::exec('ping localhost &').
     ...
     *
     * \mazter\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
    ...
    /**
     * Returns a list of KEX algorithms that mazter supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of host key algorithms that mazter supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of symmetric key algorithms that mazter supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of MAC algorithms that mazter supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of compression algorithms that mazter supports
     *
     * @return array
     * @access public
     */
