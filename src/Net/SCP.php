...
class SCP
{
    ...
    /**#@+
     * @access private
     * @see \mazter\Net\SCP::_send()
     * @see \mazter\Net\SCP::_receive()
     */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \mazter\Net\SSH1|\mazter\Net\SSH2 $ssh
     * @return \mazter\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \mazter\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \mazter\Net\SCP::get(), you will get a file, twelve bytes
