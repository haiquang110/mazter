 ...
 *
 *    $agent = new \mazter\System\SSH\Agent();
 *
...
namespace mazter\System\SSH;

use mazter\Crypt\RSA;
use mazter\System\SSH\Agent\Identity;

/**
 * Pure-PHP ssh-agent client identity factory
 *
 * requestIdentities() method pumps out \mazter\System\SSH\Agent\Identity objects
 *
 * @package SSH\Agent
 * @author  Jim Wigginton <terrafrost@php.net>
 * @access  public
...
class Agent
{
     ...
     * Default Constructor
     *
     * @return \mazter\System\SSH\Agent
     * @access public
     */
     ...
     * Returns an array containing zero or more \mazter\System\SSH\Agent\Identity objects
     *
     * @return array
     * @access public
     */
