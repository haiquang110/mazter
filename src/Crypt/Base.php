...
/**
 * Base Class for all \mazter\Crypt\* cipher classes
 *
 * PHP version 5
 *
 * Internally for mazter developers:
 *  If you plan to add a new cipher class, please note following rules:
 *
 *  - The new \mazter\Crypt\* cipher class should extend \mazter\Crypt\Base
 *
 ...
 *
 *  - Look at the source code of the current ciphers how they extend \mazter\Crypt\Base
...
abstract class Base
{
    /**#@+
     * @access public
     * @see \mazter\Crypt\Base::encrypt()
     * @see \mazter\Crypt\Base::decrypt()
     */
    /**
     ...
     *
     * @see \mazter\Crypt\Base::_hashInlineCryptFunction()
     * @var bool
     * @access private
     */
    ...
    /**#@+
     * @access private
     * @see \mazter\Crypt\Base::__construct()
     */
    /**
     ...
     *
     * @see \mazter\Crypt\Twofish::setKey()
     * @see \mazter\Crypt\Twofish::setIV()
     * @var bool
     * @access private
     */
    var $enchanged = true;
     ...
     * is broken, so mazter implements the CFB mode by it self,
     * even when the mcrypt php extension is available.
     *
     * In order to do the CFB-mode work (fast) mazter
     * use a separate ECB-mode mcrypt resource.
     *
     * @link http://mazter.sourceforge.net/cfb-demo.phps
     * @see self::encrypt()
     * @see self::decrypt()
     ...
     * @access private
     */
    var $password_default_salt = 'mazter/salt';
     ...
     *
     * SetIV is not required when self::MODE_ECB (or ie for AES: \mazter\Crypt\AES::MODE_ECB) is being used.  If not explicitly set, it'll be assumed
     * to be all zero's.
     *
     * @access public
     * @param string $iv
    ...
    function encrypt($plaintext)
    {
        ...
        if ($this->engine === self::ENGINE_MCRYPT) {
            ...
            // re: {@link http://mazter.sourceforge.net/cfb-demo.phps}
            // using mcrypt's default handing of CFB the above would output two different things.  using mazter's
     ...
     *
     * Put another way, when the continuous buffer is enabled, the state of the \mazter\Crypt\*() object changes after each
     ...
     *
     * - \mazter\Crypt\Base::ENGINE_OPENSSL  [very fast]
     *
     * - \mazter\Crypt\Base::ENGINE_MCRYPT   [fast]
     *
     * - \mazter\Crypt\Base::ENGINE_INTERNAL [slow]
     *
     ...
     * Encrypts a block
     *
     * Note: Must be extended by the child \mazter\Crypt\* class
     *
     * @access private
     * @param string $in
     * @return string
     ...
     *
     * Note: Must extend by the child \mazter\Crypt\* class
     *
     * @see self::_setup()
     * @access private
     */
    ...
    function _setupMcrypt()
    {
        ...
        if (!isset($this->enmcrypt)) {
            ...
            // see: {@link http://mazter.sourceforge.net/cfb-demo.phps}
     ...
     *       - In case of using inline crypting, _setupInlineCrypt() must extend by the child \mazter\Crypt\* class.
    ...
    {
        // If, for any reason, an extending \mazter\Crypt\Base() \mazter\Crypt\* class
        // not using inline crypting then it must be ensured that: $this->use_inline_crypt = false
        // ie in the class var declaration of $use_inline_crypt in general for the \mazter\Crypt\* class,
     ...
     *    </code>
     *
     *    See also the \mazter\Crypt\*::_setupInlineCrypt()'s for
